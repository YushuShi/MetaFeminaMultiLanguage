...
{"pmid":"...","major_outcomes":[{"major_site_id":"breast|uterus|ovary","general_outcome_reported":true,"subcategory_outcomes":[{"subcategory_id":"allowed ID","status":"reported_separate_estimate|reported_no_separate_estimate|unclear_needs_full_text","evidence_text":"short supplied-text evidence","needs_full_text":true,"estimates":[{"context_id":"known ID","effect_size":number,"lower_ci":number,"upper_ci":number,"effect_type":"RR|IRR|OR|HR|...","cases":number|null,"sample_size":number|null,"comparison_type":"...","supporting_text":"quoted/paraphrased supplied-text support"}]}]}]}
